...
if [ "$#" -lt 3 ]; then
  ...
  echo "  Usage: $0 <dirname to be deployed> <name on Cloud Functions> <bucket name> <entry point: default=main_event>"
  echo ""
  exit 1
fi
...
echo -e "\e[33m deploying GCS-triggered function [${FUNC_NAME}] to bucket [${BUCKET_NAME}] \e[m"
